...
/****** Object:  StoredProcedure [dbo].[GetProblemsInProgressAllProducts_4_5]    Script Date: 20/10/2023 15:20:49 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	LEFT JOIN [Product] P ON T.[NameTicket] = P.[ProductName]  -- Ajout de la jointure avec la table Product
    WHERE
